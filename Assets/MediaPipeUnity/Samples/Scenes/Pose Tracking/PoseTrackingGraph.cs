...
namespace Mediapipe.Unity.PoseTracking
{
  public class PoseTrackingGraph : GraphRunner
  {
    ...
    public OutputStream<NormalizedLandmarkListPacket, NormalizedLandmarkList> _poseLandmarksStream;
    public OutputStream<LandmarkListPacket, LandmarkList> _poseWorldLandmarksStream;
