...
public class TestMediapipe : MonoBehaviour
{
    ...
    [SerializeField] WebCamTexture webCamInput;
    ...
    void Start()
    {
        ...
        webCamInput = new WebCamTexture(WebCamTexture.devices[4].name);
    }
    ...
    void LateUpdate()
    {
        inputImageUI.texture = webCamInput;

        // Predict pose by neural network model.
        detecter.ProcessImage(webCamInput);
